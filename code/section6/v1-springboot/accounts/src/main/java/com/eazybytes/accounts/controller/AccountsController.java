...
public class AccountsController {
    ...
    @Operation(
          ...
          description = "Get Java version details that is used by accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<String> getJavaVersion() {
        String javaVersion = env.getProperty("JAVA_HOME");
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(javaVersion);
    }
    ...
    @Operation(
            ...
            description = "Contact Info details that can be reached out for any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
